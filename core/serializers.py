...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        seller = Seller.objects.create(**seller_data) # Check if seller already exist
        buyer = Buyer.objects.create(**buyer_data) # Check if Buyer already exist
...
class InvoiceListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = ['invoice_number','seller_name','buyer_name','total_landed_cost']
