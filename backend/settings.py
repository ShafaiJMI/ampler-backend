...
SECRET_KEY = 'django-insecure-7a8%9x#9az-r@wob^7n-!ipk!nx(%=@0ll&n))jr=esyv*u11l'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://192.168.1.2:3000",  # React app's URL
    # Add other allowed origins (e.g., your production frontend URL)
]
